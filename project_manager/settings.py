...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-5r^6bv!yaifg^@cy3ux%xd82^rajjt68+5*e$0c#vdr*we!p6n')
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'A comprehensive project management API with task tracking, notifications, and collaboration features',
    'VERSION': '1.0.0',
